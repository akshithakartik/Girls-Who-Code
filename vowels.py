...
for char in sentence:   # iterates through each character in the sentence using for loop
    if char in count:   # checks if the character in the sentence matches any vowel in the dictionary
